...
export const ar = {
  ...
  // Home page
  home: {
    welcome: 'مرحباً بك في شركة الريان للحلول التكنولوجية',
    description: 'متخصصون في توريد وتركيب الأبواب الأوتوماتيك والشيش الحصير والهاندريل وكبائن الحمامات',
    services: 'خدماتنا',
  ...
  services: {
    title: 'الخدمات',
    subtitle: 'اكتشف خدماتنا المتخصصة في الأبواب الأوتوماتيك والحلول التكنولوجية',
  ...
  cart: {
    empty: 'سلتك فارغة',
    emptyMessage: 'ابدأ التسوق لإضافة منتجات لسلتك',
  ...
  // WhatsApp
  whatsapp: {
    sendOrder: 'إرسال الطلب عبر الواتساب',
    orderMessage: 'مرحباً! أريد طلب المنتجات التالية:',
  },
