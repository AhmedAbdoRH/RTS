...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 w-full z-50 bg-[#1c594e]/90 backdrop-blur-md border-b border-[#ffd453]/20">
        <div className="container mx-auto px-4 py-2 flex items-center justify-between">
          ...
          <div className="hidden md:block relative flex-1 max-w-xl mx-8" ref={searchRef}>
            <div className="relative hidden md:block flex-1 max-w-2xl">
              <input
                ...
                className="text-glow w-full bg-white/10 text-white placeholder-white/50 rounded-lg py-2 px-10 focus:outline-none focus:ring-2 focus:ring-[#ffd453] transition-all duration-300 text-right"
              />
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="md:hidden p-2 text-white hover:text-[#ffd453] transition-colors"
              aria-label="Search"
            >
            ...
            <nav>
              <ul className="flex gap-4 md:gap-6 items-center">
                <li className="hidden md:block">
                  <Link to="/" className="text-white hover:text-[#ffd453] transition-colors duration-300 text-glow">
                    {t('header.navigation.home')}
                  </Link>
                </li>
                <li>
                  <a href="#contact" className="text-white hover:text-[#ffd453] transition-colors duration-300 text-glow">
                ...
                <li className="relative" ref={cartRef}>
                  <div className="relative">
                    <button
                      ...
                      className="relative p-2 text-white hover:text-[#ffd453] transition-colors"
                    ...
                    >
                      <div className="relative">
                        ...
                        {itemCount > 0 && (
                          <span className="absolute -top-2 -right-2 bg-[#ffd453] text-[#1c594e] text-xs font-bold rounded-md h-5 min-w-[20px] flex items-center justify-center px-1 border-2 border-black/10 shadow-sm">
                            ...
                            <div key={item.id} className="flex items-center gap-3 py-3 border-b border-white/5 last:border-0">
                              ...
                              <div className="flex-1 text-right">
                                ...
                                <div className="flex items-center justify-between mt-1">
                                  <span className="text-[#ffd453] font-bold">{item.price} EGP</span>
                        ...
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="text-right">
                              <div className="text-[#ffd453] font-bold text-lg">
                                {(() => {
                                  try {
                          ...
                          <button 
                            ...
                            className="w-full bg-[#ffd453] hover:brightness-110 text-[#1c594e] font-bold py-3 rounded-lg flex items-center justify-center gap-2 transition-all duration-300"
                          >
            ...
            <AnimatePresence>
              {isMobileSearchOpen && (
                <motion.div 
                  ...
                  className="fixed top-20 left-0 right-0 bg-[#1c594e] border-b border-[#ffd453]/10 overflow-hidden z-40 md:hidden"
                >
                  <div className="p-4">
                    <div className="relative">
                      <input
                        ...
                        dir="auto"
                        placeholder={t('header.search.placeholder')}
                        className="w-full bg-white/10 text-white placeholder-white/50 rounded-lg py-3 px-10 focus:outline-none focus:ring-2 focus:ring-[#ffd453]"
                      />
                      <Search className="absolute right-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-white/50" />
                      {searchQuery && (
                        <button
