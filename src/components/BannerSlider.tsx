      ...
      {banners.map((banner, idx) => (
        ...
        >
          {banner.type === 'image' && banner.image_url ? (
            ...
            <div className="w-full h-full min-h-full flex flex-col justify-center items-center bg-[#1c594e] backdrop-blur-xl p-8 sm:p-12 border border-white/10 shadow-2xl">
              {banner.title && (
  <h1
  className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-2 text-center text-[#ffd453]"
...
{banner.description && (
  <p
    className="text-lg sm:text-xl mb-4 text-center text-white/80"
